...
STDAPI DllGetExperimentalActivationFactory(void* classId, void** factory) noexcept {
  try {
    *factory = nullptr;
    ...
    learning_model_builder_class << XSTRINGIFY(WINML_ROOT_NS)
                                 << ".AI.MachineLearning.Experimental.LearningModelBuilder";
    ...
    learning_model_operator_class << XSTRINGIFY(WINML_ROOT_NS)
                                  << ".AI.MachineLearning.Experimental.LearningModelOperator";
    ...
    learning_model_session_experimental_class << XSTRINGIFY(WINML_ROOT_NS)
                                              << ".AI.MachineLearning.Experimental.LearningModelSessionExperimental";
    ...
    learning_model_experimental_class << XSTRINGIFY(WINML_ROOT_NS)
                                      << ".AI.MachineLearning.Experimental.LearningModelExperimental";
    ...
    learning_model_join_options_class << XSTRINGIFY(WINML_ROOT_NS)
                                      << ".AI.MachineLearning.Experimental.LearningModelJoinOptions";
...
// LoadLibraryW isn't support on Windows 8.1. This is a workaround so that CppWinRT calls this function for loading
// libraries
