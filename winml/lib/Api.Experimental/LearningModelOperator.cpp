...
hstring LearningModelOperator::Name() { return name_; }

hstring LearningModelOperator::Type() { return type_; }

hstring LearningModelOperator::Domain() { return domain_; }

wfc::IMap<winrt::hstring, winrt::hstring> LearningModelOperator::InputMapping() { return input_mapping_; }

wfc::IMap<winrt::hstring, wf::IInspectable> LearningModelOperator::ConstantInputMapping() {
  return constant_input_mapping_;
}

wfc::IMap<winrt::hstring, winrt::hstring> LearningModelOperator::OutputMapping() { return output_mapping_; }

wfc::IMap<winrt::hstring, wf::IInspectable> LearningModelOperator::AttributeMap() { return attribute_values_; }
