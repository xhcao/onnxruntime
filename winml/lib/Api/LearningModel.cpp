...
bool LearningModel::IsDisposed() { return model_ == nullptr; }
...
_winml::IEngineFactory* LearningModel::GetEngineFactory() { return engine_factory_.get(); }

void LearningModel::SaveToFile(const hstring& file_name) { model_->SaveModel(file_name.c_str(), file_name.size()); }
