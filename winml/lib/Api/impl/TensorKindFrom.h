...
// We need to define our own type for Half since DirectX::PackedVector::Half resolves to uint16_t per its typedef
// declaration. Templates require an actual type name to resolve correctly.
struct Half {
