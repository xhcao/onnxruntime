...
void LearningModelEvaluationResult::CorrelationId(const hstring& correlationId) { m_correlationId = correlationId; }

int32_t LearningModelEvaluationResult::ErrorStatus() try { return m_errorStatus; }
WINML_CATCH_ALL

void LearningModelEvaluationResult::ErrorStatus(int32_t errorStatus) { m_errorStatus = errorStatus; }

bool LearningModelEvaluationResult::Succeeded() try { return m_succeeded; }
WINML_CATCH_ALL

void LearningModelEvaluationResult::Succeeded(bool succeeded) { m_succeeded = succeeded; }
