...
void LearningModelSession::Initialize() {
  ...
  // Register transformers - this should probably not be exposed on IEngine, but an internal call as this configuration
  // step is ort specific.
...
void LearningModelSession::Close() { engine_ = nullptr; }
...
_winml::IEngine* LearningModelSession::GetEngine() { return engine_.get(); }
