...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(
        testing::Values(
            ...
            // std::make_tuple(L"fns-candy_Bgr8_Batch3.onnx", Image, std::vector<std::wstring>({L"1080.jpg",
            // L"fish_720_Gray.png", L"fish_720.png"}), 3, false), std::make_tuple(L"fns-candy_Bgr8_Batch3.onnx", Image,
            // std::vector<std::wstring>({L"1080.jpg", L"kitten_224.png", L"fish_720.png"}), 3, false),
            // std::make_tuple(L"fns-candy_Bgr8_tensor_Batch3.onnx", Tensor, std::vector<std::wstring>({L"1080.jpg",
            // L"fish_720_Gray.png", L"fish_720.png"}), 3, false),
            // std::make_tuple(L"fns-candy_Bgr8_freeDimInput_Batch10.onnx", Image, std::vector<std::wstring>({}), 10,
            // false), std::make_tuple(L"fns-candy_Bgr8.onnx", Image, std::vector<std::wstring>({L"1080.jpg",
            // L"fish_720_Gray.png", L"fish_720.png"}), 3, false), std::make_tuple(L"fns-candy_Bgr8.onnx", Image,
            // std::vector<std::wstring>({L"1080.jpg", L"fish_720_Gray.png", L"fish_720.png"}), 3, true)
        ),
        testing::Values(Bound, Unbound),
        testing::Values(Async, Sync),
...
// Tests if GPU will throw TDR if the same image feature value is binded back to back for two different inputs to a
// model
...
// Tests if GPU will throw TDR if 2 different image feature values are binded back to back for two different inputs to a
// model
...
TEST_F(ImageTests, SynchronizeGPUWorkloads) { SynchronizeGPUWorkloads(L"fns-candy.onnx", L"fish_720.png"); }
