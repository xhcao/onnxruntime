...
enum class DeviceType { CPU, DirectX, D3D11Device, D3D12CommandQueue, DirectXHighPerformance, DirectXMinPower, Last };
...
static void CreateDirectXDevice() { WINML_EXPECT_NO_THROW(CreateDevice(DeviceType::DirectX)); }

static void CreateD3D11DeviceDevice() { WINML_EXPECT_NO_THROW(CreateDevice(DeviceType::D3D11Device)); }

static void CreateD3D12CommandQueueDevice() { WINML_EXPECT_NO_THROW(CreateDevice(DeviceType::D3D12CommandQueue)); }

static void CreateDirectXHighPerformanceDevice() {
  WINML_EXPECT_NO_THROW(CreateDevice(DeviceType::DirectXHighPerformance));
}

static void CreateDirectXMinPowerDevice() { WINML_EXPECT_NO_THROW(CreateDevice(DeviceType::DirectXMinPower)); }
