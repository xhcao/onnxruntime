...
std::unordered_map<std::string, std::string> disabledTests({
    ...
    {"mask_rcnn_opset10_GPU",
     "Bug 31005388: mask_rcnn opset 10 onnx zoo model fails to evaluate on DirectML "
     "https://microsoft.visualstudio.com/OS/_workitems/edit/31005388"},
    {"faster_rcnn_opset10_GPU",
     "Bug 31005511: Failed to extract tensor data from evaluate result of faster_rcnn opset 10 model in DirectML "
     "https://microsoft.visualstudio.com/OS/_workitems/edit/31005511"},
    ...
    {"fp16_test_tiny_yolov2_opset7_GPU",
     "Bug 31005780: Result of fp16_test_tiny_yolov2_opset7 and fp16_coreml_FNS_Candy_opset7 models on DirectML aren't "
     "as accurate as on CPU https://microsoft.visualstudio.com/OS/_workitems/edit/31005780"},
    ...
    {"mlperf_ssd_mobilenet_300_opset10_GPU",
     "Bug 31005624: mlperf_ssd_mobilenet_300 opset 10 model fails to evaluate in DirectML "
     "https://microsoft.visualstudio.com/OS/_workitems/edit/31005624"},
});
...
std::unordered_map<std::string, std::pair<std::string, std::string>> disabledGpuAdapterTests({
    // e.g. {"fp16_inception_v1_opset7_GPU", std::make_pair("NVIDIA", "Bug 31144419: Results of fp16_inception_v1 opset7
    // and opset8 aren't accurate enough on AMD Radeon VII & Intel(R) UHD Graphics 630 & NVIDIA
    // https://microsoft.visualstudio.com/OS/_workitems/edit/31144419")},
    //      {"candy_opset9", std::make_pair("(Intel\\(R\\) (UHD )?Graphics)|(Adreno)", "Bug 31652854: Results of
    //      candy_opset9 aren't accurate enough on Intel Graphics and Qualcomm Adreno 685
    //      https://microsoft.visualstudio.com/OS/_workitems/edit/31652854")},
});
...
std::unordered_map<std::string, double> sampleTolerancePerTests({
    ...
    {"candy_opset9_GPU",
     0.00150000},  // Intel(R) UHD Graphics 630 (29.20.100.9020) AP machine has inaccurate GPU results for FNS Candy
                   // opset 9 https://microsoft.visualstudio.com/OS/_workitems/edit/30696168/
    {"fp16_tiny_yolov2_opset8_GPU",
     0.109000},  // Intel(R) UHD Graphics 630 (29.20.100.9020) AP machine has inaccurate GPU results for FNS Candy opset
                 // 9 https://microsoft.visualstudio.com/OS/_workitems/edit/30696168/
});
