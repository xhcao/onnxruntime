...
unsigned int GetRandomNumber(unsigned int max_number) { return std::rand() % max_number + 1; }
...
void MultiThreadMultiSession() { MultiThreadMultiSessionOnDevice(LearningModelDevice(LearningModelDeviceKind::Cpu)); }
...
void MultiThreadSingleSession() { MultiThreadSingleSessionOnDevice(LearningModelDevice(LearningModelDeviceKind::Cpu)); }
